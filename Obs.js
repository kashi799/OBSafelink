...
else if(Obs._delay<=0&&Obs._repeat>0){if(Obs._currentRepetition<=Obs._repeat){Obs.start();Obs.updateCookie("__Obs_Safelink_r",(Obs._currentRepetition+1))}Obs.start()}
else{Obs.start()}
return!0}
